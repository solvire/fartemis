...
MIGRATION_MODULES = {"sites": "fartemis.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "fartemis.users.context_processors.allauth_settings",
            ],
        },
    },
]
...
# https://docs.allauth.org/en/latest/account/configuration.html
ACCOUNT_ADAPTER = "fartemis.users.adapters.AccountAdapter"
# https://docs.allauth.org/en/latest/account/forms.html
ACCOUNT_FORMS = {"signup": "fartemis.users.forms.UserSignupForm"}
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
SOCIALACCOUNT_ADAPTER = "fartemis.users.adapters.SocialAccountAdapter"
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
SOCIALACCOUNT_FORMS = {"signup": "fartemis.users.forms.UserSocialSignupForm"}
# django-compressor
# ------------------------------------------------------------------------------
...
SPECTACULAR_SETTINGS = {
    "TITLE": "fartemis API",
    "DESCRIPTION": "Documentation of API endpoints of fartemis",
    "VERSION": "1.0.0",
...
GITHUB_ACCESS_TOKEN = env("GITHUB_ACCESS_TOKEN", default=None)
